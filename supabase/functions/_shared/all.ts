...
const TEMPLATES: Record<string, string> = {
    batch_confirmation: `<!DOCTYPE html>
<html>
...
<body
    style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; background-color: #f3f4f6;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
        ...
        <div style="padding: 30px 20px;">
            ...
            <p style="font-size: 16px; color: #374151; margin: 0 0 25px 0;">
                We're pleased to confirm that <strong>{{shift_count}} shift{{shift_count_plural}}</strong> have been
                successfully filled for your facility{{date_range}}.
            </p>

            <!-- SUMMARY BOX -->
            <div
                style="background-color: #d1fae5; border: 2px solid #059669; border-radius: 12px; padding: 20px; text-align: center; margin-bottom: 25px;">
                ...
                <div style="display: flex; justify-content: center; gap: 30px; margin-top: 12px; flex-wrap: wrap;">
                    ...
                    <div style="text-align: center;">
                        <div style="font-size: 24px; font-weight: bold; color: #059669;">{{total_hours}}h</div>
            ...
            <div style="text-align: center; margin-bottom: 30px;">
                <a href="{{portal_url}}"
                    style="display: inline-block; background-color: #10b981; color: #ffffff; padding: 14px 28px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 16px;">
            ...
            <!-- DETAILED SCHEDULE -->
            <h2
                style="color: #1f2937; font-size: 18px; margin: 30px 0 15px 0; border-bottom: 2px solid #e5e7eb; padding-bottom: 10px;">
                📅 Detailed Schedule
            </h2>
            ...
            <div style="margin-top: 30px; padding: 15px; background: #f9fafb; border-radius: 8px;">
                <div style="font-size: 14px; color: #6b7280; margin-bottom: 10px;">
                    <strong>📍 Location:</strong> {{client_name}}
                </div>
                <div style="font-size: 14px; color: #6b7280; margin-bottom: 10px;">
                    <strong>🔔 Reminder:</strong> Staff will arrive 10-15 minutes before shift start
                </div>
                <div style="font-size: 14px; color: #6b7280;">
                    <strong>📞 Questions?</strong> Contact {{agency_name}} at
                    <a href="mailto:{{agency_email}}"
                        style="color: #0284c7; text-decoration: none;">{{agency_email}}</a>
                </div>
            </div>
        </div>
        ...
        <div style="background: #f9fafb; padding: 15px; text-align: center;">
            <p style="margin: 0; font-size: 12px; color: #94a3b8;">
                <a href="{{preferences_url}}" style="color: #64748b; text-decoration: underline;">
        ...
        <div style="background: #1e293b; color: #94a3b8; padding: 20px; text-align: center;">
            <p style="margin: 0; font-size: 13px;">© {{current_year}} {{agency_name}}. All rights reserved.</p>
            <p style="margin: 10px 0 0 0; font-size: 12px;">
                Need help? Contact us at <a href="mailto:{{agency_email}}"
                    style="color: #06b6d4; text-decoration: none;">{{agency_email}}</a>
            </p>
